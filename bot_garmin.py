...
def get_garmin_data():
    try:
        ...
        try:
            actividades = client.get_activities(0, 1)
            data['ultima_actividad'] = actividades[0] if actividades else "Sin actividades recientes"
        except:
            data['ultima_actividad'] = "No disponible"
